...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser("Run Hunyuan3D + legacy dmesh-branch DLMesh refinement using shared Hunyuan3D cache.")
...
# Usage:
#   python reconstruction/recon_hunyuan3d_dmesh.py --data-root dataset_train --split val --work-root reconstruction_runs --objects bottle_3517 --gpus 0 --num-workers 1
#   python reconstruction/recon_hunyuan3d_dmesh.py --data-root /data/dataset_train --split val --work-root /shared/recon_runs --object-source all --gpus 0,1 --num-workers 2 --mode multi_image --coord-dir /shared/recon_coord/hunyuan3d_dmesh --reset-coord
#
# Key parameters:
#   --work-root: shared cache root. Reads <work-root>/hunyuan3d and writes <work-root>/hunyuan3d_dmesh.
...
#   --copy-base-as-placeholder: dry-run only; explicitly copies Hunyuan3D mesh without DLMesh optimization.
