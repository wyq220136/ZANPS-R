...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser("Smoke test SAM3D + DMesh on selected dataset_train/val objects.")
    ...
    parser.add_argument("--no-build-base", action="store_true", help="Require existing SAM3D cache instead of building it.")
...
def main() -> None:
    ...
    cmd = [
        sys.executable,
        str(repo / "reconstruction" / "run" / "recon_sam3d_dmesh.py"),
        "--data-root",
        args.data_root,
        "--split",
        args.split,
