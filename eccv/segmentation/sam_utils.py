...
DEFAULT_SEGMENT_ANYTHING_ROOT = os.environ.get(
    "SEGMENT_ANYTHING_ROOT",
    "/inspire/hdd/project/robot-dna/jiangyixuan-CZXS25230137/yuquan/related_works/segment-anything",
)
if os.path.isdir(DEFAULT_SEGMENT_ANYTHING_ROOT) and DEFAULT_SEGMENT_ANYTHING_ROOT not in sys.path:
    sys.path.insert(0, DEFAULT_SEGMENT_ANYTHING_ROOT)
