...
# ==========================================
IMAGE_PATH = "/inspire/qb-dev/project/robot-dna/jiangyixuan-CZXS25230137/yuquan/test_intra/rgb/Remote_101028_0_0.png"
MASK_PATH = "/inspire/qb-dev/project/robot-dna/jiangyixuan-CZXS25230137/yuquan/test_intra/extracted_masks/mask_label_1.png"
SAVE_PATH = "/inspire/qb-dev/project/robot-dna/jiangyixuan-CZXS25230137/yuquan/test_intra/extracted_masks/overlay.png"
# ==========================================

load_dotenv()
ImageFile.LOAD_TRUNCATED_IMAGES = True
CHECK_MODEL_NAME = "Qwen3-VL-235B-A22B-Instruct"
BASE_URL = "https://qoojh8bcjp9hcdgpkdmcbc8jgjkh98bq.openapi-sj.sii.edu.cn/v1"
...
2. Overlay Image (same mask overlaid on RGB)

Your task is to determine whether the selected region is a precise, complete, and user-operable articulated part.
...
handle, knob, button, switch, key, drawer, lid, door and other functional parts.
...
def get_openai_client():
    ...
    if _GLOBAL_CLIENT is None:
        ...
        if not api_key:
            raise RuntimeError("QWEN_KEY is not set")
